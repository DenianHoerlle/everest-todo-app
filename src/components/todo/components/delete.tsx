...
const animateValues: AnimateValues[] = [
  { values: "#9fbdcd; #f96673; #f96673; #f96673;", offset: 0 },
  { values: "#9fbdcd; #9fbdcd; #f96673; #f96673;", offset: 0.5 },
  { values: "#9fbdcd; #9fbdcd; #9fbdcd; #f96673;", offset: 1 },
];
...
const ThrashIconSVG = (isAnimating: boolean, id: number) => {
  ...
  const renderAnimatedGradient = (data: AnimateValues) => {
    return (
      <stop offset={data.offset} stop-color="#f96673">
        <animate
  ...
  return (
    <svg
      ...
      <path
        fill={isAnimating ? `url(#appear-gradient-${id})` : "#9fbdcd"}
